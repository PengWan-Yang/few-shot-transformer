...
class resnet_tdcnn(nn.Module):
    def __init__(self, depth=34):
        super(resnet_tdcnn, self).__init__()
        self.depth = depth
        self.shortcut_type = 'A'
        self.model_path = './pretrained_model/resnet-{}-kinetics.pth'.format(depth)
        self._init_modules()

    def _init_modules(self):
        net_str = "resnet{}(sample_size=112, sample_duration={}, shortcut_type=\'{}\')".format(self.depth, 768, self.shortcut_type)
        resnet = eval(net_str)
    ...
    def train(self, mode=True):
        ...
        if mode:
            ...
            self.features.eval()
            self.features[4].train()
            self.features[5].train()
            self.features[6].train()
