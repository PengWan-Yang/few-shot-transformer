...
print('Generate Validation Segments')
train_segment = generate_segment('validation', data, classes, FRAME_DIR)

train_roidb = generate_roidb('validation', train_segment)
print(len(train_roidb))
print("Save dictionary")
t = 0
pickle.dump(train_roidb, open('val_data_cls{}.pkl'.format(NUM_CLS), 'wb'), pickle.HIGHEST_PROTOCOL)